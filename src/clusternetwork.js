...
var _cdcCreatedBySystem = "System";
var _cdcCreatedByManual = "Manual";
    ...
    */
    ...
    self.priority_set_editor = jsPanel.create({
      ...
      callback: function () {
        ...
        cluster_tracking = cluster_tracking || _cdcTrackingOptionsDefault;

        grp_tracking_select
          .selectAll("option")
          .data(_cdcTrackingOptions)
          .enter()
          .insert("option")
          .text((d) => d)
        ...
        let modifiedDate =
          validation_mode == "validate" && created_by == _cdcCreatedBySystem
            ? self.today
            : self.getCurrentDate();
  ...
  self.generate_coi_temporal_report = function (ref_set, D) {
    ...
    const report = {
      node_info: _.map(ref_set.node_objects, (n) => [
        n.id,
        _defaultDateViewFormatSlider(
          self.attribute_node_value_by_id(n, _networkCDCDateField)
        ),
      ]),
  ...
  self.update = function (soft, friction) {
    ...
    if (!soft) {
      ...
      if (
        ...
        try {
          graph_data[_networkGraphAttrbuteID]["subcluster_or_priority_node"] =
            self._aux_process_category_values(
              self._aux_populate_category_fields(
                graph_data[_networkGraphAttrbuteID][
                  "subcluster_or_priority_node"
